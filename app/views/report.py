...
from app.models.db import get_db, t_report_definition, t_report_request, t_led
from app.models.utils import create_led_report_template, get_menu_items, get_leds
...
def edit():
    ...
    *create_led_report_template* for this Demo App. Normally you'd probably
    ...
    with db_engine.begin() as connection:
        report_count = connection.execute(
            ...
            .where(t_report_definition.c.report_type == 'led_report')
        ).scalar()
        if report_count == 0:
            create_led_report_template()
